...
define(['./workbox-f001acab'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    ...
    "url": "/offline",
    "revision": "0.ea52ev9ipng"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("/offline"), {
    allowlist: [/^\/$/]
  }));
  workbox.registerRoute(/^https:\/\/fra\.cloud\.appwrite\.io\/v1\/storage\/buckets\/.*/, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/^https:\/\/fra\.cloud\.appwrite\.io\/v1\/databases\/.*/, new workbox.NetworkFirst({
